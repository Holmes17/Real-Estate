    ...
    <div class="<?php print esc_html($wpestate_options['content_class']);?>">
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="col-md-8 contact_page_company_details">
                ...
                <?php      
                    if ($telephone_no) {
                        print '<div class="agent_detail contact_detail"><i class="fa fa-phone"></i><a href="tel:' . esc_html($telephone_no) . '">'; print esc_html( $telephone_no ). '</a></div>';
                    }

                     if ($mobile_no) {
                        print '<div class="agent_detail contact_detail"><i class="fa fa-mobile"></i><a href="tel:' . esc_html( $mobile_no ) . '">'; print  esc_html ($mobile_no) . '</a></div>';
                    }

                    if ($company_email) {
                        print '<div class="agent_detail contact_detail"><i class="fa fa-envelope-o"></i>'; print '<a href="mailto:'.esc_html($company_email).'">' .esc_html( $company_email ). '</a></div>';
                    }
